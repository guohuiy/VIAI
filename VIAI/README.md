...
```bash
# 构建镜像
docker build -t viai:latest .

# 运行容器
docker run --gpus all -v ./models:/app/models -v ./plugins:/app/plugins viai:latest
```
...
```cpp
#include "viai_core/plugin_interface.h"
...
- 项目主页: [https://github.com/your-org/viai](https://github.com/your-org/viai)
- 邮箱: contact@viai.com
- 文档: [docs/](docs/)
